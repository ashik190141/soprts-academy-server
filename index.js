...
async function run() {
  try {
    ...
    // await client.connect();
      ...
      const adminCollection = client.db('sports').collection('requestClasses');
      const selectClassesCollection = client.db('sports').collection('selectedClasses');
    ...
    app.patch('/admin/feedback/:id', async (req, res) => {
        ...
        const result = await adminCollection.updateOne(filter, updatedUser, options);
        res.send(result);
    })
    ...
    app.post('/selectedClass', async (req, res) => {
        ...
        const result = await selectClassesCollection.insertOne(selectedClass);
        res.send(result);
    })
    ...
    app.get('/home', async (req, res) => {
      ...
      const result = await adminCollection.find().sort(sort).limit(6).toArray();
      res.send(result);
    })
